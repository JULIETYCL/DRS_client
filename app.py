...
# DataRepositoryService
    ...
    access_parser = subparsers.add_parser("access", help = "access the URL that can be used to fetch the bytes of a DrsObject")
...
# DRS-Filer
    ...
    post_parser.add_argument("--access_url_headers", type=str, nargs="+", default=["string"], help="List of access URL headers (default: ['string'])")
    ...
    post_parser.add_argument("--aliases", type=str, nargs="+", default=["string"], help="List of aliases (default: ['string'])")
    ...
    post_parser.add_argument("--drs_uri", type=str, nargs="+", default=["drs://drs.example.org/314159", "drs://drs.example.org/213512"], help="List of DRS URIs (default: ['drs://drs.example.org/314159', 'drs://drs.example.org/213512'])")
    ...
    post_parser.add_argument("--created_time", type=str, default="2023-04-16T18:56:55.077Z", help="Created time in RFC3339 format (default: '2023-04-16T18:56:55.077Z')")
    post_parser.add_argument("--description", type=str, default="string", help="Description (default: 'string')")
    post_parser.add_argument("--mime_type", type=str, default="application/json", help="MIME type (default: 'application/json')")
    ...
    post_parser.add_argument("--updated_time", type=str, default="2023-04-16T18:56:55.077Z", help="Updated time in RFC3339 format (default: '2023-04-16T18:56:55.077Z')")
    ...
    put_parser.add_argument("--access_url_headers", type=str, nargs="+", default=["string"], help="List of access URL headers (default: ['string'])")
    ...
    put_parser.add_argument("--aliases", type=str, nargs="+", default=["string"], help="List of aliases (default: ['string'])")
    ...
    put_parser.add_argument("--drs_uri", type=str, nargs="+", default=["drs://drs.example.org/314159", "drs://drs.example.org/213512"], help="List of DRS URIs (default: ['drs://drs.example.org/314159', 'drs://drs.example.org/213512'])")
    put_parser.add_argument("--contents_name", type=str, default="string", help="Contents name (default: 'string')")
    put_parser.add_argument("--created_time", type=str, default="2023-04-16T18:56:55.077Z", help="Created time in RFC3339 format (default: '2023-04-16T18:56:55.077Z')")
    put_parser.add_argument("--description", type=str, default="string", help="Description (default: 'string')")
    put_parser.add_argument("--mime_type", type=str, default="application/json", help="MIME type (default: 'application/json')")
    ...
    put_parser.add_argument("--updated_time", type=str, default="2023-04-16T18:56:55.077Z", help="Updated time in RFC3339 format (default: '2023-04-16T18:56:55.077Z')")
    ...
    post_info_parser.add_argument("--createdAt", type=str, default="2023-04-16T18:56:55.077Z", help="created time in RFC3339 format (default: '2023-04-16T18:56:55.077Z')")

# service-info

    # 8. get service info
    get_service_parser = subparsers.add_parser("get_service_info", help = "Get service information")
   ...
   # Parse command-line arguments 
    ...
    if args.action == "post":
        ...
        created_time=args.created_time, description=args.description,mime_type=args.mime_type, name=args.name,size=args.size,
        updated_time=args.updated_time,version=args.version)
    elif args.action == "get":
        functions.get_function(id=args.id, expand=args.expand)
    elif args.action == "delete":
        functions.delete_function(id=args.id)
    elif args.action == "put":
        functions.put_function(id=args.id,access_url_headers=args.access_url_headers, access_url=args.access_url, access_type=args.access_type, aliases=args.aliases,
        checksum=args.checksum,checksum_type=args.checksum_type, drs_uri=args.drs_uri, contents_name=args.contents_name,
        created_time=args.created_time, description=args.description,mime_type=args.mime_type, name=args.name,size=args.size,
        updated_time=args.updated_time,version=args.version)
    elif args.action == "access":
        functions.access_function(id = args.id,access_id= args.access)
    elif args.action == "post_service_info":
        functions.post_info_function(contactUrl=args.contact_url, createdAt = args.createdAt, description = args.description)
